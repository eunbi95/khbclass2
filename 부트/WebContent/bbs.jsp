	...
	<div class="container">
		...
		<div class="container">
			...
			<!-- <form action="searchBbs.jsp" method="get" >
				...
				<a href="write.jsp?userID=<%=userID%>" class="btn-primary pull-right">글쓰기</a>
			</div>
		</div>
		<div class=container style="text-align:center">
			<%
				BbsDAO bbsDAO1 = new BbsDAO();
				int pages = (int) Math.ceil(bbsDAO1.getCount()/10)+1;
				for(int i=1; i<=pages; i++){ %>
					<button type="button" onclick="location.href='bbs.jsp?pageNumber=<%=i %>'"><%=i %></button>
				<%} %>
		</div>
	</div>
